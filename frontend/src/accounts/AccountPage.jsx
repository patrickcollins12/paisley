...
const AccountPage = () => {
  ...
  const accounts = [
    { asset_liability: "asset", name: "Bankwest Offset", accountType: "Savings", balance: 12946, currency: "AUD", lastUpdated: new Date(), trend: "+3.2%", interestRate: "4.2%", interestYoY: "-0.1%" },
